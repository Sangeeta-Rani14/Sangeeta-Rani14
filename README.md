<!-- <h1 align="center">Hi 👋, I'm Sangeeta Rani</h1>
...
| **Frontend** | `React.js` `Next.js` `Redux Toolkit` `RTK Query` `GSAP` `Tailwind` `MUI` |
| **Backend** | `Node.js` `Express.js` `REST APIs` |
| **Database** | `PostgreSQL` `MongoDB` `MySQL` |
| **Tools** | `Git` `Docker` `Postman` `Figma` `Vite` |

---

### 📈 Professional Snapshot

- **Software Developer @ Shaurya Software** (2023 - 2025)
    - Architected a dynamic RBAC system for School ERPs, boosting onboarding speed by **50%**.
    - Built a custom JSON-schema-driven Form Builder, slashing backend dependency by **90%**.
- **Full Stack Intern @ Hoping Mind** (2023)
    - Deployed a secure E-commerce platform using the MERN stack and JWT authentication.

---

### 📂 Featured Project: DevKstra Judge
*A platform designed to help beginners bridge the gap between "Tutorial Hell" and real-world coding.*
- **Focus:** Curated minimal problems to build developer confidence.
